...
return (
    <div className="popupWindow">
      ...
      {!loggedIn && !showCreateUserOptions ? <div><Login />
      <button className="popupExtrasBtn" onClick={() => setShowCreateUserOptions(true)}>Skapa konto</button></div> : "" }
      {loggedIn ? <button className="popupExtrasBtn" onClick={() => logout()}>Logga ut</button>: "" }
